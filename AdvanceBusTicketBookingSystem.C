/*
    ...
    Authors:            Sarvang Dave(17DCS009),Dhruvin Gohil(17DCS016),Prince Makwana(17DCS027)
    Guide:              Ms. Sneha Padhiar
    Submission Date:    16 November, 2017
    Code Name:          AdvanceBusTicketBookingSystem.C
    Description:        This system is made for an imaginary bus service provider blueInk Travels.
                        This is designed to reduce the efforts to book a tour.
*/
...
void top(); //welcome note at top of each page
...
void add_bus()
{
    ...
    do
    {
        ...
        artime:
            ...
            {
                printf("\n\t\tInvalid Time!!!!\n");
                printf("\t\tEnter only in hh:mm format!!!!");
                goto artime;
            }
        deptime:
        ...
        printf("\n");
        empty();
        printf("\n\n\n\tDo you want to continue to add a new bus(y/n)?? ");
        fflush(stdin);
        scanf("%c",&chChoice);
        num++;
...
void disp_status()
{
    ...
    printf("\n\n\t\tDo you want to continue with another bus(y/n)??");
    fflush(stdin);
    ch=getchar();
    if(ch=='y'||ch=='Y')
        disp_status();
...
void top()
{
    printf("\t\t\tWelcome to blueInk Bus Services\n");
